...
Run `make` in the top-level directory. By default the demos are not built. Run
`make COQPROJECT=_CoqProject.all` to build the demos. Be warned that it takes a
long time and a lot of memory at the moment.
